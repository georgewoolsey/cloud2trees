...
#> $ fia_est_dbh_cm            <dbl> 50.752452, 39.450064, 48.156979, 32.289387, …
#> $ fia_est_dbh_cm_lower      <dbl> 23.774845, 18.626396, 23.164270, 15.286148, …
#> $ fia_est_dbh_cm_upper      <dbl> 86.05558, 66.60246, 80.42751, 54.36259, 39.8…
#> $ dbh_cm                    <dbl> 50.752452, 39.450064, 48.156979, 32.289387, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.50752452, 0.39450064, 0.48156979, 0.322893…
#> $ radius_m                  <dbl> 0.25376226, 0.19725032, 0.24078489, 0.161446…
#> $ basal_area_m2             <dbl> 0.202303756, 0.122232107, 0.182141265, 0.081…
#> $ basal_area_ft2            <dbl> 2.17759763, 1.31570640, 1.96056858, 0.881420…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ tree_cbh_m                <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ is_training_cbh           <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
#> $ tree_x                 <dbl> 458066.0, 458057.8, 458083.8, 458056.0, 458057.…
#> $ tree_y                 <dbl> 4450066, 4450081, 4450081, 4450091, 4450068, 44…
#> $ tree_height_m          <dbl> 8.264013, 13.767122, 1.699402, 2.660260, 4.7400…
#> $ geometry               <POINT [m]> POINT (458066 4450066), POINT (458057.8 4…
#> $ fia_est_dbh_cm         <dbl> 13.809977, 26.863896, 3.256744, 4.508197, 7.374…
#> $ fia_est_dbh_cm_lower   <dbl> 6.092787, 11.862730, 1.469252, 1.957941, 3.3128…
#> $ fia_est_dbh_cm_upper   <dbl> 24.156475, 46.576768, 5.713061, 7.826040, 12.83…
#> $ dbh_cm                 <dbl> 13.809977, 26.863896, 3.256744, 4.508197, 7.374…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.13809977, 0.26863896, 0.03256744, 0.04508197,…
#> $ radius_m               <dbl> 0.06904988, 0.13431948, 0.01628372, 0.02254098,…
#> $ basal_area_m2          <dbl> 0.0149787574, 0.0566797422, 0.0008330233, 0.001…
#> $ basal_area_ft2         <dbl> 0.161231344, 0.610100745, 0.008966663, 0.017181…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 457978.6, 458125.4, 457978.8, 457904.2, 457840.…
#> $ tree_y                 <dbl> 4450024, 4450022, 4450113, 4449965, 4449962, 44…
#> $ geometry               <POINT [m]> POINT (457978.6 4450024), POINT (458125.4…
...
#> $ tree_cbh_m      <dbl> 3.730114, 3.819214, 2.500000, 4.157700, 3.704781, 4.50…
#> $ is_training_cbh <lgl> FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, TRUE, FALSE, F…
...
#> $ max_crown_diam_height_m <dbl> 3.412166, 4.681000, 8.943000, 3.151000, 3.2190…
