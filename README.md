...
#> $ fia_est_dbh_cm            <dbl> 51.201336, 39.306503, 47.883427, 32.409371, …
#> $ fia_est_dbh_cm_lower      <dbl> 24.916342, 19.050961, 22.302176, 15.455034, …
#> $ fia_est_dbh_cm_upper      <dbl> 87.42276, 66.58145, 81.25876, 54.58628, 39.2…
#> $ dbh_cm                    <dbl> 51.201336, 39.306503, 47.883427, 32.409371, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.51201336, 0.39306503, 0.47883427, 0.324093…
#> $ radius_m                  <dbl> 0.25600668, 0.19653251, 0.23941713, 0.162046…
#> $ basal_area_m2             <dbl> 0.205898164, 0.121344106, 0.180077862, 0.082…
#> $ basal_area_ft2            <dbl> 2.21628784, 1.30614796, 1.93835810, 0.887983…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ tree_cbh_m                <dbl> 16.355767, 14.058833, 15.454600, 13.401233, …
...
#> $ tree_x                 <dbl> 458065.3, 458069.3, 458057.2, 458051.9, 458077.…
#> $ tree_y                 <dbl> 4450063, 4450084, 4450072, 4450079, 4450086, 44…
#> $ tree_height_m          <dbl> 4.322058, 3.138092, 7.117151, 2.620424, 1.72636…
#> $ geometry               <POINT [m]> POINT (458065.3 4450063), POINT (458069.3…
#> $ fia_est_dbh_cm         <dbl> 6.775416, 5.057322, 11.644732, 4.396438, 3.2705…
#> $ fia_est_dbh_cm_lower   <dbl> 2.918085, 2.231405, 5.100181, 1.974199, 1.42966…
#> $ fia_est_dbh_cm_upper   <dbl> 11.856367, 8.771354, 20.377554, 7.650497, 5.701…
#> $ dbh_cm                 <dbl> 6.775416, 5.057322, 11.644732, 4.396438, 3.2705…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.06775416, 0.05057322, 0.11644732, 0.04396438,…
#> $ radius_m               <dbl> 0.03387708, 0.02528661, 0.05822366, 0.02198219,…
#> $ basal_area_m2          <dbl> 0.0036054695, 0.0020087737, 0.0106499828, 0.001…
#> $ basal_area_ft2         <dbl> 0.038809274, 0.021622440, 0.114636414, 0.016340…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 458015.4, 458000.3, 458089.8, 458102.3, 458068.…
#> $ tree_y                 <dbl> 4449994, 4450053, 4450107, 4450036, 4450088, 44…
#> $ geometry               <POINT [m]> POINT (458015.4 4449994), POINT (458000.3…
#> $ forest_type_group_code <chr> "280", "280", "900", "280", "900", "280", "280"…
#> $ forest_type_group      <chr> "Lodgepole pine group", "Lodgepole pine group",…
#> $ hardwood_softwood      <chr> "Softwood", "Softwood", "Hardwood", "Softwood",…
```
...
#>   forest_type_group_code forest_type_group                         n
#>   <chr>                  <chr>                                 <int>
#> 1 200                    Douglas-fir group                        16
#> 2 260                    Fir / spruce / mountain hemlock group     1
#> 3 280                    Lodgepole pine group                     43
#> 4 900                    Aspen / birch group                       6
```
...
#> $ tree_cbh_m      <dbl> 3.236252, 3.534733, 4.124233, 1.500000, 3.224752, 3.50…
...
#> $ max_crown_diam_height_m <dbl> 3.457771, 4.681000, 8.943000, 3.151000, 3.2190…
