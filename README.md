...
#> $ fia_est_dbh_cm            <dbl> 51.441870, 39.514881, 47.984758, 32.327879, …
#> $ fia_est_dbh_cm_lower      <dbl> 24.191639, 19.029402, 22.781983, 15.245646, …
#> $ fia_est_dbh_cm_upper      <dbl> 87.45303, 66.11982, 81.10922, 54.52743, 39.5…
#> $ dbh_cm                    <dbl> 51.441870, 39.514881, 47.984758, 32.327879, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.51441870, 0.39514881, 0.47984758, 0.323278…
#> $ radius_m                  <dbl> 0.25720935, 0.19757440, 0.23992379, 0.161639…
#> $ basal_area_m2             <dbl> 0.207837246, 0.122634094, 0.180840836, 0.082…
#> $ basal_area_ft2            <dbl> 2.23716011, 1.32003339, 1.94657076, 0.883523…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
#> $ tree_x                 <dbl> 458052.0, 458059.9, 458060.7, 458065.7, 458056.…
#> $ tree_y                 <dbl> 4450079, 4450073, 4450043, 4450089, 4450073, 44…
#> $ tree_height_m          <dbl> 2.323772, 2.013597, 10.459249, 2.025436, 11.122…
#> $ geometry               <POINT [m]> POINT (458052 4450079), POINT (458059.9 4…
#> $ fia_est_dbh_cm         <dbl> 3.979218, 3.635962, 18.793957, 3.635962, 19.943…
#> $ fia_est_dbh_cm_lower   <dbl> 1.854585, 1.715567, 8.870959, 1.715567, 9.29361…
#> $ fia_est_dbh_cm_upper   <dbl> 6.715373, 6.164615, 31.842621, 6.164615, 33.881…
#> $ dbh_cm                 <dbl> 3.979218, 3.635962, 18.793957, 3.635962, 19.943…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.03979218, 0.03635962, 0.18793957, 0.03635962,…
#> $ radius_m               <dbl> 0.01989609, 0.01817981, 0.09396978, 0.01817981,…
#> $ basal_area_m2          <dbl> 0.0012436130, 0.0010383134, 0.0277412697, 0.001…
#> $ basal_area_ft2         <dbl> 0.013386251, 0.011176405, 0.298607027, 0.011176…
