...
#> $ fia_est_dbh_cm            <dbl> 51.095642, 39.400342, 48.031378, 32.138445, …
#> $ fia_est_dbh_cm_lower      <dbl> 24.115845, 18.493446, 23.384500, 15.047207, …
#> $ fia_est_dbh_cm_upper      <dbl> 86.05837, 66.57076, 81.81090, 54.14051, 39.5…
#> $ dbh_cm                    <dbl> 51.095642, 39.400342, 48.031378, 32.138445, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.51095642, 0.39400342, 0.48031378, 0.321384…
#> $ radius_m                  <dbl> 0.25547821, 0.19700171, 0.24015689, 0.160692…
#> $ basal_area_m2             <dbl> 0.205048971, 0.121924186, 0.181192402, 0.081…
#> $ basal_area_ft2            <dbl> 2.20714713, 1.31239194, 1.95035502, 0.873199…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
#> $ tree_x                 <dbl> 458055.0, 458078.2, 458071.9, 458049.2, 458057.…
#> $ tree_y                 <dbl> 4450081, 4450083, 4450074, 4450088, 4450082, 44…
#> $ tree_height_m          <dbl> 2.118310, 2.998279, 2.421118, 1.740629, 4.89150…
#> $ geometry               <POINT [m]> POINT (458055 4450081), POINT (458078.2 4…
#> $ fia_est_dbh_cm         <dbl> 3.728720, 4.886815, 4.113312, 3.245237, 7.78298…
#> $ fia_est_dbh_cm_lower   <dbl> 1.628515, 2.114316, 1.751862, 1.390016, 3.38942…
#> $ fia_est_dbh_cm_upper   <dbl> 6.540577, 8.548811, 7.295852, 5.658466, 13.6544…
#> $ dbh_cm                 <dbl> 3.728720, 4.886815, 4.113312, 3.245237, 7.78298…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.03728720, 0.04886815, 0.04113312, 0.03245237,…
#> $ radius_m               <dbl> 0.01864360, 0.02443407, 0.02056656, 0.01622619,…
#> $ basal_area_m2          <dbl> 0.0010919665, 0.0018756062, 0.0013288416, 0.000…
#> $ basal_area_ft2         <dbl> 0.011753927, 0.020189025, 0.014303651, 0.008903…
