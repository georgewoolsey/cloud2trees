...
#> $ crown_area_m2             <dbl> 10.4375, 4.1250, 2.6250, 1.1250, 4.4375, 6.3…
...
if we think that the “log_fn” was the most appropriate for our area, we
...
best_ws <- itd_tuning_ans$ws_fn_list$log_fn
```
...
#> $ fia_est_dbh_cm            <dbl> 32.232710, 25.452071, 50.862995, 53.231760, …
#> $ fia_est_dbh_cm_lower      <dbl> 15.293768, 12.020336, 24.048747, 25.110392, …
#> $ fia_est_dbh_cm_upper      <dbl> 55.193167, 43.124732, 85.650801, 89.229181, …
#> $ dbh_cm                    <dbl> 32.232710, 25.452071, 50.862995, 53.231760, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.32232710, 0.25452071, 0.50862995, 0.532317…
#> $ radius_m                  <dbl> 0.16116355, 0.12726036, 0.25431497, 0.266158…
#> $ basal_area_m2             <dbl> 0.081598751, 0.050878717, 0.203185979, 0.222…
#> $ basal_area_ft2            <dbl> 0.87832896, 0.54765851, 2.18709388, 2.395549…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
#> [1] "Default trees extracted: 370 || Custom trees extracted: 340"
```
...
#> $ tree_x                 <dbl> 458064.1, 458053.5, 458054.8, 458076.9, 458080.…
#> $ tree_y                 <dbl> 4450097, 4450070, 4450063, 4450099, 4450082, 44…
#> $ tree_height_m          <dbl> 1.295461, 1.305261, 18.107464, 1.418679, 4.4889…
#> $ geometry               <POINT [m]> POINT (458064.1 4450097), POINT (458053.5…
#> $ fia_est_dbh_cm         <dbl> 2.786646, 2.786646, 39.084333, 2.889444, 7.0824…
#> $ fia_est_dbh_cm_lower   <dbl> 1.240493, 1.240493, 17.148156, 1.302860, 3.1512…
#> $ fia_est_dbh_cm_upper   <dbl> 4.862101, 4.862101, 67.591522, 5.021706, 12.238…
#> $ dbh_cm                 <dbl> 2.786646, 2.786646, 39.084333, 2.889444, 7.0824…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.02786646, 0.02786646, 0.39084333, 0.02889444,…
#> $ radius_m               <dbl> 0.01393323, 0.01393323, 0.19542167, 0.01444722,…
#> $ basal_area_m2          <dbl> 0.0006098928, 0.0006098928, 0.1199762533, 0.000…
#> $ basal_area_ft2         <dbl> 0.006564886, 0.006564886, 1.291424390, 0.007058…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 458072.3, 458033.0, 458086.0, 458092.8, 457949.…
#> $ tree_y                 <dbl> 4449980, 4450075, 4449986, 4450043, 4450055, 44…
#> $ geometry               <POINT [m]> POINT (458072.3 4449980), POINT (458033 4…
#> $ forest_type_group_code <chr> "280", "200", "280", "200", "200", "280", "200"…
#> $ forest_type_group      <chr> "Lodgepole pine group", "Douglas-fir group", "L…
...
#>   forest_type_group_code forest_type_group        n
#>   <chr>                  <chr>                <int>
#> 1 200                    Douglas-fir group       44
#> 2 220                    Ponderosa pine group     2
#> 3 280                    Lodgepole pine group    20
```
...
#> $ tree_cbh_m      <dbl> 4.039837, 4.500000, 8.500000, 2.500000, 4.500000, 3.50…
...
#> $ max_crown_diam_height_m <dbl> 3.484698, 4.681000, 8.943000, 3.151000, 3.2190…
