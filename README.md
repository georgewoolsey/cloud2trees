...
#> $ fia_est_dbh_cm            <dbl> 49.381647, 31.448027, 17.217700, 24.839444, …
#> $ fia_est_dbh_cm_lower      <dbl> 28.211482, 17.808003, 9.737227, 14.201070, 2…
#> $ fia_est_dbh_cm_upper      <dbl> 75.029400, 47.788797, 26.266835, 38.060322, …
#> $ dbh_cm                    <dbl> 49.381647, 31.448027, 17.217700, 24.839444, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.49381647, 0.31448027, 0.17217700, 0.248394…
#> $ radius_m                  <dbl> 0.24690824, 0.15724013, 0.08608850, 0.124197…
#> $ basal_area_m2             <dbl> 0.191523042, 0.077674180, 0.023283065, 0.048…
#> $ basal_area_ft2            <dbl> 2.06155402, 0.83608487, 0.25061892, 0.521611…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ tree_cbh_m                <dbl> 15.500000, 8.500000, 7.254400, 11.461800, 20…
...
#> $ max_crown_diam_height_m   <dbl> 9.190000, 8.963184, 6.053534, 1.670000, 16.3…
#> $ is_training_hmd           <lgl> TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, …
#> $ landfire_stand_id         <dbl> 49, 50, 50, 50, 51, 51, 51, 49, 50, 50, 51, …
#> $ crown_dia_m               <dbl> 3.6345371, 3.7103777, 1.2296227, 2.4102190, …
#> $ crown_length_m            <dbl> 6.7299995, 7.3500004, 2.8056004, 1.9781996, …
#> $ crown_volume_m3           <dbl> 46.5491635, 52.9812527, 2.2211003, 6.0170237…
#> $ landfire_tree_kg_per_m3   <dbl> 0.2165958, 0.1641721, 0.1641721, 0.1641721, …
#> $ landfire_stand_kg_per_m3  <dbl> 0.08, 0.08, 0.08, 0.08, 0.08, 0.08, 0.08, 0.…
#> $ landfire_crown_biomass_kg <dbl> 10.08235121, 8.69804613, 0.36464281, 0.98782…
```
...
#> $ tree_x                 <dbl> 458061.5, 458066.7, 458058.3, 458063.6, 458075.…
#> $ tree_y                 <dbl> 4450083, 4450082, 4450082, 4450065, 4450068, 44…
#> $ tree_height_m          <dbl> 2.901967, 1.803959, 3.102621, 1.559377, 4.77457…
#> $ geometry               <POINT [m]> POINT (458061.5 4450083), POINT (458066.7…
#> $ fia_est_dbh_cm         <dbl> 5.206431, 3.738761, 5.485973, 3.473974, 8.07743…
#> $ fia_est_dbh_cm_lower   <dbl> 2.889637, 2.143264, 3.119752, 1.964729, 4.58774…
#> $ fia_est_dbh_cm_upper   <dbl> 7.973138, 5.679477, 8.459330, 5.303620, 12.2665…
#> $ dbh_cm                 <dbl> 5.206431, 3.738761, 5.485973, 3.473974, 8.07743…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.05206431, 0.03738761, 0.05485973, 0.03473974,…
#> $ radius_m               <dbl> 0.02603216, 0.01869380, 0.02742987, 0.01736987,…
#> $ basal_area_m2          <dbl> 0.0021289729, 0.0010978555, 0.0023637268, 0.000…
#> $ basal_area_ft2         <dbl> 0.02291626, 0.01181732, 0.02544315, 0.01020274,…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 458101.6, 457983.3, 458055.8, 457917.2, 458045.…
#> $ tree_y                 <dbl> 4450125, 4449925, 4450059, 4449930, 4450034, 44…
#> $ geometry               <POINT [m]> POINT (458101.6 4450125), POINT (457983.3…
#> $ forest_type_group_code <chr> "900", "280", "200", "200", "220", "200", "200"…
...
#> $ tree_cbh_m      <dbl> 4.048831, 4.516309, 8.500000, 2.500000, 4.048831, 3.50…
#> $ is_training_cbh <lgl> FALSE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, FA…
...
#> $ max_crown_diam_height_m <dbl> 3.534480, 4.681000, 8.943000, 3.151000, 3.2190…
