...
#> $ fia_est_dbh_cm            <dbl> 31.977567, 25.606536, 50.840879, 53.141335, …
#> $ fia_est_dbh_cm_lower      <dbl> 15.254425, 12.179239, 23.584263, 25.038133, …
#> $ fia_est_dbh_cm_upper      <dbl> 53.833100, 43.336901, 85.458037, 89.402731, …
#> $ dbh_cm                    <dbl> 31.977567, 25.606536, 50.840879, 53.141335, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.31977567, 0.25606536, 0.50840879, 0.531413…
#> $ radius_m                  <dbl> 0.15988784, 0.12803268, 0.25420440, 0.265706…
#> $ basal_area_m2             <dbl> 0.080312052, 0.051498141, 0.203009323, 0.221…
#> $ basal_area_ft2            <dbl> 0.86447892, 0.55432599, 2.18519235, 2.387418…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
#> $ tree_x                 <dbl> 458076.7, 458084.3, 458051.9, 458058.2, 458076.…
#> $ tree_y                 <dbl> 4450061, 4450073, 4450070, 4450088, 4450069, 44…
#> $ tree_height_m          <dbl> 1.769429, 45.471058, 1.588148, 3.722473, 6.3572…
#> $ geometry               <POINT [m]> POINT (458076.7 4450061), POINT (458084.3…
#> $ fia_est_dbh_cm         <dbl> 3.390604, 119.918750, 3.138727, 5.892658, 10.17…
#> $ fia_est_dbh_cm_lower   <dbl> 1.488785, 51.630598, 1.381854, 2.575862, 4.5527…
#> $ fia_est_dbh_cm_upper   <dbl> 5.881513, 212.259923, 5.464884, 10.276752, 17.4…
#> $ dbh_cm                 <dbl> 3.390604, 119.918750, 3.138727, 5.892658, 10.17…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.03390604, 1.19918750, 0.03138727, 0.05892658,…
#> $ radius_m               <dbl> 0.01695302, 0.59959375, 0.01569364, 0.02946329,…
#> $ basal_area_m2          <dbl> 0.0009029091, 1.1294423475, 0.0007737435, 0.002…
#> $ basal_area_ft2         <dbl> 0.009718914, 12.157317428, 0.008328575, 0.02935…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 458125.6, 457845.3, 458023.5, 458148.9, 457852.…
#> $ tree_y                 <dbl> 4450077, 4449977, 4449902, 4449981, 4449920, 44…
#> $ geometry               <POINT [m]> POINT (458125.6 4450077), POINT (457845.3…
#> $ forest_type_group_code <chr> "200", "200", "280", "200", "200", "200", "280"…
...
#> $ tree_cbh_m      <dbl> 4.051894, 4.500000, 8.500000, 3.927200, 4.500000, 3.50…
#> $ is_training_cbh <lgl> FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE, FAL…
...
#> $ max_crown_diam_height_m <dbl> 3.567443, 4.681000, 8.943000, 3.151000, 3.2190…
