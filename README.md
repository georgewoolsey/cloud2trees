...
if we think that the “exp_fn” was the most appropriate for out area, we
...
``` r
ggplot2::ggplot() +
  ggplot2::geom_function(fun = best_ws, color = "navy", lwd = 1) +
  ggplot2::xlim(-5,60) +
...
#> $ fia_est_dbh_cm            <dbl> 32.193206, 25.498694, 50.983224, 53.442960, …
#> $ fia_est_dbh_cm_lower      <dbl> 15.214098, 12.055656, 24.428969, 25.392388, …
#> $ fia_est_dbh_cm_upper      <dbl> 54.535202, 43.165136, 86.451682, 89.514905, …
#> $ dbh_cm                    <dbl> 32.193206, 25.498694, 50.983224, 53.442960, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.32193206, 0.25498694, 0.50983224, 0.534429…
#> $ radius_m                  <dbl> 0.16096603, 0.12749347, 0.25491612, 0.267214…
#> $ basal_area_m2             <dbl> 0.081398865, 0.051065283, 0.204147687, 0.224…
#> $ basal_area_ft2            <dbl> 0.87617739, 0.54966671, 2.19744570, 2.414596…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
...
cloud2trees_ans_c$crowns_sf %>%
  ...
  ggplot2::geom_point(color = "brown", alpha = 0.6) +
...
#> $ tree_x                 <dbl> 458089.8, 458051.5, 458063.0, 458071.0, 458063.…
#> $ tree_y                 <dbl> 4450065, 4450068, 4450082, 4450059, 4450086, 44…
#> $ tree_height_m          <dbl> 3.679964, 2.152955, 7.891603, 4.586309, 4.51984…
#> $ geometry               <POINT [m]> POINT (458089.8 4450065), POINT (458051.5…
#> $ fia_est_dbh_cm         <dbl> 5.891733, 3.865486, 13.008953, 7.225610, 7.1041…
#> $ fia_est_dbh_cm_lower   <dbl> 2.483430, 1.655510, 5.497158, 3.041543, 3.03846…
#> $ fia_est_dbh_cm_upper   <dbl> 10.413192, 6.876966, 22.962159, 12.808303, 12.4…
#> $ dbh_cm                 <dbl> 5.891733, 3.865486, 13.008953, 7.225610, 7.1041…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.05891733, 0.03865486, 0.13008953, 0.07225610,…
#> $ radius_m               <dbl> 0.02945867, 0.01932743, 0.06504477, 0.03612805,…
#> $ basal_area_m2          <dbl> 0.0027263149, 0.0011735405, 0.0132915182, 0.004…
#> $ basal_area_ft2         <dbl> 0.029346053, 0.012631990, 0.143069902, 0.044137…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 457944.5, 457884.8, 457899.4, 458071.7, 458044.…
#> $ tree_y                 <dbl> 4450097, 4449953, 4449823, 4450109, 4450003, 44…
#> $ geometry               <POINT [m]> POINT (457944.5 4450097), POINT (457884.8…
#> $ forest_type_group_code <chr> "200", "200", "220", "200", "280", "200", "200"…
...
#> 2 220                    Ponderosa pine group                      5
#> 3 260                    Fir / spruce / mountain hemlock group     1
#> 4 280                    Lodgepole pine group                     20
```
...
#> $ tree_cbh_m      <dbl> 4.063766, 4.532968, 8.500000, 2.500000, 4.500000, 3.50…
#> $ is_training_cbh <lgl> FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FAL…
...
#> $ max_crown_diam_height_m <dbl> 3.482584, 4.681000, 8.943000, 3.151000, 3.2190…
