...
#> $ fia_est_dbh_cm            <dbl> 51.113517, 39.256709, 47.803937, 32.155055, …
#> $ fia_est_dbh_cm_lower      <dbl> 24.400167, 18.388091, 22.411888, 15.295636, …
#> $ fia_est_dbh_cm_upper      <dbl> 86.33040, 67.11906, 80.91922, 54.24568, 39.2…
#> $ dbh_cm                    <dbl> 51.113517, 39.256709, 47.803937, 32.155055, …
#> $ is_training_data          <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FA…
#> $ dbh_m                     <dbl> 0.51113517, 0.39256709, 0.47803937, 0.321550…
#> $ radius_m                  <dbl> 0.25556759, 0.19628355, 0.23901968, 0.160775…
#> $ basal_area_m2             <dbl> 0.205192468, 0.121036864, 0.179480472, 0.081…
#> $ basal_area_ft2            <dbl> 2.20869173, 1.30284081, 1.93192781, 0.874101…
#> $ ptcld_extracted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ ptcld_predicted_dbh_cm    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ tree_cbh_m                <dbl> 18.500000, 14.837467, 15.500000, 11.500000, …
#> $ is_training_cbh           <lgl> TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE…
...
#> $ tree_x                 <dbl> 458072.2, 458067.4, 458040.9, 458065.6, 458057.…
#> $ tree_y                 <dbl> 4450090, 4450065, 4450074, 4450082, 4450080, 44…
#> $ tree_height_m          <dbl> 1.888976, 15.809772, 11.208300, 10.320106, 1.38…
#> $ geometry               <POINT [m]> POINT (458072.2 4450090), POINT (458067.4…
#> $ fia_est_dbh_cm         <dbl> 3.509616, 32.509628, 20.493944, 18.283857, 2.88…
#> $ fia_est_dbh_cm_lower   <dbl> 1.580755, 14.191840, 9.250425, 8.030390, 1.2803…
#> $ fia_est_dbh_cm_upper   <dbl> 6.122929, 57.313632, 35.476416, 31.385026, 5.01…
#> $ dbh_cm                 <dbl> 3.509616, 32.509628, 20.493944, 18.283857, 2.88…
#> $ is_training_data       <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE…
#> $ dbh_m                  <dbl> 0.03509616, 0.32509628, 0.20493944, 0.18283857,…
#> $ radius_m               <dbl> 0.01754808, 0.16254814, 0.10246972, 0.09141928,…
#> $ basal_area_m2          <dbl> 0.0009674067, 0.0830068410, 0.0329868606, 0.026…
#> $ basal_area_ft2         <dbl> 0.010413166, 0.893485636, 0.355070567, 0.282617…
...
#> Columns: 7
#> $ treeID                 <chr> "1", "2", "3", "4", "5", "6", "7", "8", "9", "1…
#> $ tree_x                 <dbl> 458018.6, 457972.0, 458045.2, 458015.7, 457888.…
#> $ tree_y                 <dbl> 4449955, 4449832, 4449955, 4449995, 4450001, 44…
#> $ geometry               <POINT [m]> POINT (458018.6 4449955), POINT (457972 4…
#> $ forest_type_group_code <chr> "280", "280", "280", "280", "200", "280", "280"…
...
#>   forest_type_group_code forest_type_group                         n
#>   <chr>                  <chr>                                 <int>
#> 1 200                    Douglas-fir group                        13
#> 2 260                    Fir / spruce / mountain hemlock group     5
#> 3 280                    Lodgepole pine group                     44
...
#> $ comp_relative_tree_height <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ comp_dist_to_nearest_m    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
#> $ tree_cbh_m                <dbl> 3.356415, 3.383509, 3.927861, 3.647269, 3.35…
#> $ is_training_cbh           <lgl> FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, TRU…
