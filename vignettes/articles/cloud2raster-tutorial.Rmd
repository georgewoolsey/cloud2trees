...
While the plot shows a fair amount of variation, let’s remember it only represents `r scales::comma(diff(terra::minmax(cloud2raster_ans$dtm_rast)),accuracy = 0.01)` m of vertical relief. If we looked at an area with 60 m of vertical relief, for example, we would not even notice these small fluctuations.
