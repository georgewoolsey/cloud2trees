...
let's load the `cloud2trees` package into our current session and we'll also load some of the `tidyverse` and `terra` for working with raster data
...
Next, it is recommended to check out the [Overview](cloud2trees-overview.html)
