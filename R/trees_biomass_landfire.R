...
trees_biomass_landfire <- function(
  ...
  trees_landfire_ans <- trees_landfire(
    tree_list = tree_list
    , crs = crs
  ...
  # the data is
  tree_list <- trees_landfire_ans$tree_list
  landfire_rast <- trees_landfire_ans$landfire_rast
...
####################################################################
# INTERMEDIATE FUNCTION TO ATTACH LANDFIRE CBD TO TREE LIST
# THIS IS THE SAME PROCESS AS trees_type()
####################################################################
trees_landfire <- function(
  tree_list
  , crs = NA
  , study_boundary = NA
  , input_landfire_dir = NULL
