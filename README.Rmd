...
* `lidR` package ([https://github.com/r-lidar/lidR](https://github.com/r-lidar/lidR)) for fundamental point cloud processing capabilities and routines
...
* `TreeLS` package ([https://github.com/tiagodc/TreeLS](https://github.com/tiagodc/TreeLS)) helps us extract DBH directly from the point cloud
...
A full demonstration script of the install and setup of `cloud2trees` including dependencies is available at: `article("cloud2trees-setup")`
